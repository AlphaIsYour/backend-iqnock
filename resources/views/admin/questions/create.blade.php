...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('admin.questions.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label class="block text-gray-700 font-bold mb-2">Question Image *</label>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="correct_answer" value="{{ old('correct_answer') }}" required placeholder="e.g., KUCING"
